...
define('DB_NAME', '_manage_db'); // Wat is de database naam
...
define('DEFAULT_CONTROLLER', 'Empty'); 			// Dit is de standaard controller waarmee de webapplictie wordt opgestart
